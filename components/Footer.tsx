    ...
    <div className="w-full max-w-screen-lg lg:px-0 px-4 m-auto pt-[100px] mb-10">
      ...
      <div className="flex flex-col-reverse  lg:flex-row gap-7 lg:gap-0 lg:justify-between">
        ...
        <div className="flex flex-col gap-2">
          ...
          <address className="flex items-center gap-x-2 cursor-pointer">
          ...
          <address className="flex items-center gap-x-2 cursor-pointer">
            ...
            <a
              target="_blank"
              rel="noopener"
              href="https://www.google.com/maps/place/Vul.+Heroyiv+Maydanu,+15,+Bucha,+Kyivs'ka+oblast,+08292/@50.550914, 30.214758,18z/data=!3m1!4b1!4m6!3m5!1s0x472b31b8c0de22a1:0xbd398d80c7ce2c99!8m2!3d50.5519049!4d30.215133!16s%2Fg%2F11vq9mn492?entry=ttu"
            >
              {address}
            </a>
          </address>
